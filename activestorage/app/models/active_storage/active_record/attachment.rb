...
class ActiveStorage::ActiveRecord::Attachment < ActiveStorage::ActiveRecord::Record
...
ActiveSupport.run_load_hooks :active_storage_attachment, ActiveStorage::ActiveRecord::Attachment
